...
public interface ProjectRepository extends JpaRepository<Project, Long> {
    ...
    @Modifying
    @Query("update Project p set p.currentSum = :currentSumParam where p.id = :idParam")
    void setCurrentSumById(@Param("currentSumParam") Long currentSum, @Param("idParam") Long id);
}
